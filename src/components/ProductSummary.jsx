  ...
  return (
    <div className="shadow space-y-1 p-4 bg-white">
      <div className="space-y-2">
        ...
        <p className="text-lg font-bold text-violet-jtc">Precio: {formatMoney(price)} </p>
        <p className="text-lg text-gray-700 text-orange-crayola">Subtotal: {formatMoney(price * amount)} </p>
      </div>
