...
export default function Register() {
    return (
        <>
            ...
            <div className="mt-10 shadow-md rounded-md px-5 py-10 bg-ghost-white">
                <form action="">
                    <div className="mb-5">
                        ...
                        <input type="text" id="name" name="name" placeholder="Tu nombre" className="w-full mt-1 p-2 border border-gray-300 rounded-md" />
                    </div>
                    <div className="mb-5">
                    ...
                    <div className="mb-5">
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Repetir contraseña" className="w-full mt-1 p-2 border border-gray-300 rounded-md" />
                    </div>
                    <div>
            ...
            <nav className="mt-5">
                <Link to="/auth/login" className="text-gray">
